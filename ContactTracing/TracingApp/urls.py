...
urlpatterns = [
    ...
    path('upload-travel', views.travel_import, name="travel-import"),
    path('case-upload-assign/<str:case_list>/<str:ctype>', views.case_upload_assign, name='case-upload-assign'),
